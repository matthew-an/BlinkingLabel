...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/matthew-an/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'matthew-an' => 'matthew@matthew.tips' }
  s.source           = { :git => 'https://github.com/matthew-an/BlinkingLabel.git', :tag => s.version.to_s }
